...
<p>
<strong>[2] Metric:</strong> This filter will change the metric (y-axis) the graphs display. Active cases = cases - deaths - recovered cases. <strong>Note</strong>: Any country/region lacking official recovered data displays imputed recovered data (primarily US, German, and Canadian states/provinces). This is calculated by daily recoveries = new cases 14 days ago - deaths today. This is just an approximation and not official data.
</p>
<p>
